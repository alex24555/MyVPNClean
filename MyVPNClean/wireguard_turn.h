...
/// Force reconnect all proxy connections while preserving cached creds.
/// Faster than Resume(); intended for network handovers.
void wgForceReconnect(int32_t tunnelHandle);
